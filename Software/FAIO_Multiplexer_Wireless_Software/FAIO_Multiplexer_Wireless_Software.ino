...
//FAIO_Multiplexer_Wireless Switch Software
//FAIO_Multiplexer_Wireless_Software
//Written by: Milad Hajihassan
//Version 1.0 (23/7/2020)
//Github Link: https://github.com/milador/FAIO_Multiplexer_Wireless
...
void keyboardAction(int switch1,int switch2,int switch3,int switch4) {
    if(!switch1) {
      ...
      //Serial.println("a");
      enterKeyboardChar(switchProperty[0].switchChar);
    } else if(!switch2) {
      switchFeedback(2,switchMode,switchReactionTime,1);
      //Serial.println("b");
      enterKeyboardChar(switchProperty[1].switchChar);
    } else if(!switch3) {
      switchFeedback(3,switchMode,switchReactionTime,1);
      //Serial.println("c");
      enterKeyboardChar(switchProperty[2].switchChar);
    } else if(!switch4) {
      switchFeedback(4,switchMode,switchReactionTime,1);
      //Serial.println("d");
      enterKeyboardChar(switchProperty[3].switchChar);
    }
    else
    {
      clearKeyboard();
